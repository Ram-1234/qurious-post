    ...
    <div className='listitng-post container'>
            ...
            <div className='left col-lg-8 col-md-12'>
                <div className='your-story border-bottom p-2 mt-5 mb-2'>
                    ...
                    <h1>Your Story</h1>
                     <div className='d-flex justify-content-between'>
                        <button className='btn btn-success m-3' onClick={()=>navigate('/create_post')} style={buttonStyle} >Write a Story</button>
                        <button className='btn btn-danger m-3' onClick={()=>alert('comming soon!')} style={buttonStyle} >Import a Story</button>
                     </div>
                    </div>
                ...
                <div className='list-of-stroy'>
                    {!!postData.length ? postData?.map((item,index)=>{
                        return <StoryCard
